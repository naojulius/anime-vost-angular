...
export class DashboardComponent {
  ...
  ngOnInit(){
    ...
    this.menus.forEach(menu => {
      if(menu.link.endsWith(this.router.url)){
        menu.class = "bg-gray-50 text-yellow-500";
      }else{
        menu.class = "";
      }
      newMenus.push(menu);
  ...
  menus: Array<any> = [
    ...
    {
      title: "Ma Liste",
      link: "/dashboard/profile/my-anime-list",
